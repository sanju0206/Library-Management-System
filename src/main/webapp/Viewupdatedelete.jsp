...
<table border=1>
<center>
<TR><TH>BID<TH>BOOKNAME<TH>AUTHOR<TH>PUBLISHER<TH>PRICE<TH>BOOKSTATUS<TH>COUNT<TH>YOUR CHOICE
...
%>
<TR> <TD> <%= bookid %> <TD> <%=bookname %> <TD> <%=author %> <TD> <%=publisher %> <TD><%=price %><TD> <%=bookstatus %><TD> <%=no_of_books %> <TD> <a href="update.jsp?bookid=<%= bookid %>">update</a> / <a href="delete.jsp?bookid=<%= bookid %>">delete</a>
<%
}
%>
</center>
